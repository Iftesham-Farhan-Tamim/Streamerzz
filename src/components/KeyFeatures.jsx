...
function KeyFeatures() {
    ...
    // text-center mb-12 border-t border-neutral-800
    // text-3xl lg:text-5xl mt-20
        ...
        <section className=''>
            <div className='max-w-7xl mx-auto px-4 mt-20'>
                <div className='text-center mb-12 border-t border-neutral-800'>
                    ...
                    bg-gradient-to-r from-neutral-50 via-neutral-300 to-neutral-600
                ...
                <motion.div
                    ...
                    {KEY_FEATURES_CONTENT.features.map((feature) => (
                        ...
                        items-center text-center w-full md:w-1/2 lg:w-1/3 p-6'
